...
import com.mai.pilot_assistent.di.component.ActivityComponent;
import com.mai.pilot_assistent.di.component.DaggerActivityComponent;
...
import com.mai.pilot_assistent.utils.NetworkUtils;
...
public abstract class BaseActivity extends AppCompatActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mActivityComponent = DaggerActivityComponent.builder()
                ...
                .applicationComponent(((PilotAssistentApp) getApplication()).getComponent())
                .build();
